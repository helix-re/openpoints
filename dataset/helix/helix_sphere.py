...
class HelixSphere(data.Dataset): # class S3DISSphere(data.Dataset):
    label_to_names_old = {0: 'ceiling',
                      1: 'floor',
                      2: 'wall',
                      3: 'beam',
                      4: 'column',
                      ...
                      11: 'board',
                      12: 'clutter'}
    label_to_names = {'object': 0,'ceiling': 1,'wall': 2,'door': 3,'clutter': 4,'floor': 5,'light': 6,'stair': 7,'window': 8}
    label_to_names = {'object': 0,'ceiling': 1,'wall': 2,'door': 3,'clutter': 4,'floor': 5,'light': 6,'window': 7}
    ...
    def __init__(self, voxel_size,
        ...
        self.train_clouds = ['Area_2000','Area_1125','Area_helix','Area_big','Area_jtc'] # ['Area_1', 'Area_2', 'Area_3', 'Area_4', 'Area_6']
        self.val_clouds = ['Area_4000'] # ['Area_5']
        self.split = split
